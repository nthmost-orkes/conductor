 ...
 */
package org.conductoross.conductor.webhook.util;

import java.util.LinkedList;
import java.util.List;

/**
 * A simple accumulator for error messages used during webhook verification.
 *
 * <p>OSS-side addition: Orkes uses this via a shared common module; OSS keeps it local to the
 * webhooks module to avoid adding dependencies.
 */
