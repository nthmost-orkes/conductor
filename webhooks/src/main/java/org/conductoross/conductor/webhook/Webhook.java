...
/**
 * System task that waits for an external webhook event before completing.
 *
 * <p>When this task starts, it registers itself with the {@link WebhookTaskService} so that
 * incoming webhook events can be matched to this task. The task remains IN_PROGRESS until a
 * matching webhook arrives and the {@link WebhookWorker} completes it.
 */
